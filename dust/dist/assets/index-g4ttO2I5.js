import{w as b,p as v,s as y,i as x,n as $,l as g,R,M as T,m,j as C}from"./index-DYy2l7fi.js";import{n as P,r as h,c as w}from"./index-CpETmySh.js";const a=v({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),_={state:a,subscribe(t){return x(a,()=>t(a))},subscribeKey(t,e){return y(a,t,e)},showTooltip({message:t,triggerRect:e,variant:o}){a.open=!0,a.message=t,a.triggerRect=e,a.variant=o},hide(){a.open=!1,a.message="",a.triggerRect={width:0,height:0,top:0,left:0}}},s=b(_),j=$`
  :host {
    width: 100%;
    display: block;
  }
