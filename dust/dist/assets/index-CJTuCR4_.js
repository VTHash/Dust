import{j as U,r as we,k as Ne,l as _,m as l,q as I,as as Se,o as P,at as ve,au as w,a as O,av as Pe,aw as N,O as ie,N as A,ax as ue,C as m,p as Te,D as v,E as W,S as R,y as ke,M as z,s as _e,i as Ce,z as S,R as M,v as $e,n as Re}from"./index-DYy2l7fi.js";import{n as x,c as C,r as h,U as Oe,b as ye}from"./index-CpETmySh.js";import{o as g}from"./if-defined-CSOJjIaa.js";import"./index-BitrRDCV.js";import"./index-BMo58bMK.js";import"./index-o8uj9g-m.js";import"./index-Dlx84aNm.js";import"./index-DeRVLt4f.js";import"./index-CAIukFqk.js";import"./index-C7kyvXGI.js";import"./index-D4hsZmgh.js";import{M as le}from"./MathUtil-BGCe3rZ3.js";const Ue=U`
  :host {
    position: relative;
  }
...
`;var F=function(t,e,n,s){var a=arguments.length,i=a<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,s);else for(var u=t.length-1;u>=0;u--)(o=t[u])&&(i=(a<3?o(i):a>3?o(e,n,i):o(e,n))||i);return a>3&&i&&Object.defineProperty(e,n,i),i};let k=class extends _{constructor(){super(),this.unsubscribe=[],this.amount=c.state.amount,this.namespace=void 0,this.paymentAsset=c.state.paymentAsset,this.activeConnectorIds=S.state.activeConnectorIds,this.caipAddress=void 0,this.exchanges=c.state.exchanges,this.isLoading=c.state.isLoading,this.initializeNamespace(),this.unsubscribe.push(c.subscribeKey("amount",e=>this.amount=e)),this.unsubscribe.push(S.subscribeKey("activeConnectorIds",e=>this.activeConnectorIds=e)),this.unsubscribe.push(c.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(c.subscribeKey("isLoading",e=>this.isLoading=e)),c.fetchExchanges(),c.setSelectedExchange(void 0)}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return l`
    ...
    >
      ...
      `)}templateSeparator(){return l`<wui-separator text="or" bgColor="secondary"></wui-separator>`}async onWalletPayment(){if(!this.namespace)throw new Error("Namespace not found");this.caipAddress?M.push("PayQuote"):(await S.connect(),await z.open({view:"PayQuote"}))}onExchangePayment(e){c.setSelectedExchange(e),M.push("PayQuote")}async onDisconnect(){try{await P.disconnect(),await z.open({view:"Pay"})}catch{console.error("Failed to disconnect"),R.showError("Failed to disconnect")}}getWalletProperties({namespace:e}){if(!e)return{name:void 0,image:void 0};const n=this.activeConnectorIds[e];if(!n)return{name:void 0,image:void 0};const s=S.getConnector({id:n,namespace:e});if(!s)return{name:void 0,image:void 0};const a=v.getConnectorImage(s);return{name:s.name,image:a}}};k.styles=st;F([h()],k.prototype,"amount",void 0);F([h()],k.prototype,"namespace",void 0);F([h()],k.prototype,"paymentAsset",void 0);F([h()],k.prototype,"activeConnectorIds",void 0);F([h()],k.prototype,"caipAddress",void 0);F([h()],k.prototype,"exchanges",void 0);F([h()],k.prototype,"isLoading",void 0);k=F([C("w3m-pay-view")],k);const it=U`
  :host {
    display: inline-flex;
    align-items: center;
    justify-content: center;
...
`;var j=function(t,e,n,s){var a=arguments.length,i=a<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,s);else for(var u=t.length-1;u>=0;u--)(o=t[u])&&(i=(a<3?o(i):a>3?o(e,n,i):o(e,n))||i);return a>3&&i&&Object.defineProperty(e,n,i),i};const at=3,rt=2,ot=.3,ct="200px",ut={"accent-primary":$e.tokens.core.backgroundAccentPrimary};let q=class extends _{constructor(){super(...arguments),this.rings=at,this.duration=rt,this.opacity=ot,this.size=ct,this.variant="accent-primary"}render(){const e=ut[this.variant];this.style.cssText=`
    ...
    `}renderRing(e,n){const a=`animation-delay: ${e/n*this.duration}s;`;return l`<div class="pulse-ring" style=${a}></div>`}};q.styles=[we,it];j([x({type:Number})],q.prototype,"rings",void 0);j([x({type:Number})],q.prototype,"duration",void 0);j([x({type:Number})],q.prototype,"opacity",void 0);j([x()],q.prototype,"size",void 0);j([x()],q.prototype,"variant",void 0);q=j([C("wui-pulse")],q);const ge=[{id:"received",title:"Receiving funds",icon:"dollar"},{id:"processing",title:"Swapping asset",icon:"recycleHorizontal"},{id:"sending",title:"Sending asset to the recipient address",icon:"send"}],fe=["success","submitted","failure","timeout","refund"],lt=U`
  :host {
    display: block;
    height: 100%;
    width: 100%;
